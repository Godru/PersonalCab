        ...
        return (
            <div onClick={this.menuClose} className="container">
                ...
                <div style = {{display: this.state.secondOfferDisplay}} className="offer__second">
                    ...
                    <table className="ticket-table-buy">
                        <thead>
                            <tr>
                            ...
                            <tr>
                                <th className="ticket-table__row">{this.state.dayMenuBlockNames[this.state.activeDay]}</th>
                                <th className="ticket-table__row">{this.state.ticketMenuBlockNames[this.state.activeTicket]}</th>
                                <th className="ticket-table__row">{this.state.tickets}</th>
                                <th className="ticket-table__row">{this.state.finalPrice} руб</th>
                            </tr>
                        </thead>
                    </table>
